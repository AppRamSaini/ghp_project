...
class DailyHelpProfileDetailsState extends State<DailyHelpProfileDetails> {
  ...
  void onBack(BuildContext buildContext) {
    if (widget.fromResidentPage) {
      Navigator.pushAndRemoveUntil(context,
          MaterialPageRoute(builder: (_) => Dashboard()), (route) => false);
    } else {
      Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(builder: (_) => SecurityGuardDashboard(index: 4)),
          (route) => false);
    }
  }
  ...
  /// verify the user
  void verifyTheUser(
      BuildContext context, DailyHelpUser userInfo, List<Log> logsData,
    ...
    final checkInData = {
      ...
      if (widget.fromResidentPage && propertyId != null)
  ...
  void _handleStaffSide(BuildContext context, DailyHelpUser userInfo,
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                //                   fontWeight:
                                //                       FontWeight.w500))),
                                //       // usersData.user!.staff!.dateOfJoin !=
                                //       //         null
                                //       //     ? SizedBox()
                                //       //     : Text(
                                ...
                                //                   fontWeight:
                                //                       FontWeight.w500))),
                                //       // usersData.user!.staff!
                                //       //             .contractEndDate !=
                                //       //         null
                                //       //     ? SizedBox()
                                //       //     : Text(
                                //       //         formatDateOnly(usersData.user!
                          ...
                          usersData.logs!.isEmpty
                              ...
                              : ListView.builder(
                                  ...
                                  itemBuilder: (_, index) {
                                    List<LastCheckinDetail> staffLog = usersData
                                                              ...
                                                              : Row(
                                                                  ...
                                                                  children: [
                                                                    Column(
                                                                      children: [
                                                                        Text(
                                                                            memberLogs[residentIndex]
                                                                                .dailyHelpMemberDetails!
                                                                                .name
                                                                                .toString(),
                                                                            style:
                                                                                GoogleFonts.ptSans(textStyle: TextStyle(color: Colors.black, fontSize: 11, fontWeight: FontWeight.w600))),
                                                                        Text(
                                                                            "Name",
                                                                            style:
                                                                                GoogleFonts.ptSans(textStyle: TextStyle(color: Colors.black54, fontSize: 12, fontWeight: FontWeight.w400))),
                                                                      ],
                                                                    ),
                                                                    Column(
                                                                      children: [
                                                                        Text(
                                                                            ...
                                                                            style:
                                                                                GoogleFonts.ptSans(textStyle: TextStyle(color: Colors.black, fontSize: 12, fontWeight: FontWeight.w600))),
                                                                        Text(
                                                                            "Phone",
                                                                            style:
                                                                                GoogleFonts.ptSans(textStyle: TextStyle(color: Colors.black54, fontSize: 11, fontWeight: FontWeight.w400))),
                                                                      ],
                                                                    ),
                                                                    Column(
                                                                      children: [
