        ...
        body: RefreshIndicator(
          ...
          child: BlocBuilder<EventCubit, EventState>(
            ...
            builder: (context, state) {
              if (state is EventLoading && _eventCubit.eventsListing.isEmpty) {
              ...
              if (_eventCubit.eventsListing.isEmpty) {
                return emptyDataWidget('Events Not Found!');
              }
              ...
              return ListView.builder(
                ...
                itemBuilder: ((context, index) {
                  ...
                  String formattedDate =
                      DateFormat('dd MMM yyyy').format(eventsList[index].date);
                  ...
                  String formattedTime = DateFormat.jm()
                      .format(parsedTime); // This will convert it to "6:46 PM"
