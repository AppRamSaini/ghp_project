...
class _HouseholdsViewsState extends State<HouseholdsViews> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appbarWidget(title: 'Households'),
                          ...
                          Container(
                            ...
                            child: ListTile(
                              ...
                              leading: CircleAvatar(
                                  radius: 30.h,
                                  backgroundImage:
                                      NetworkImage(usersData.image.toString()),
                                  onBackgroundImageError: (error, stack) =>
                                      const AssetImage(
                                          'assets/images/default.jpg')),
                              title: Text(
                                  capitalizeWords(usersData.name.toString()),
                                  style: GoogleFonts.nunitoSans(
                                      textStyle: TextStyle(
                                          color: Colors.black,
                                          fontSize: 16.sp,
                                          fontWeight: FontWeight.w500))),
                              subtitle: Text(
                                  capitalizeWords(usersData.status.toString()),
                                  style: GoogleFonts.nunitoSans(
                                      textStyle: TextStyle(
                                          color: Colors.green,
                                          fontSize: 14.sp,
                              ...
                              trailing: GestureDetector(
                                onTap: () => Navigator.of(context).push(
                                    MaterialPageRoute(
                                        builder: (builder) => ResidentGatePass(
                                            residentModel: state.userProfile
                                                .first.data!.user!))),
                                child: SizedBox(
                                    height: 100,
                                    width: 80,
