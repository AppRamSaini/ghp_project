...
class _RentPropertyScreenState extends State<RentPropertyScreen> {
  ...
  initData() {
    towerName = userProfileCubit
        .userProfile.first.data!.user!.property!.blockName
        .toString();
    floorNo = userProfileCubit
        .userProfile.first.data!.user!.property!.floorNumber
        .toString();
    propertyType = userProfileCubit
        .userProfile.first.data!.user!.property!.unitType
        .toString();
    aptNo = userProfileCubit.userProfile.first.data!.user!.property!.aprtNo
        .toString();
    bhkType =
        userProfileCubit.userProfile.first.data!.user!.property!.bhk.toString();
    areaSt = userProfileCubit.userProfile.first.data!.user!.property!.unitSize
        .toString();
    blockId = userProfileCubit.userProfile.first.data!.user!.property!.blockId
        .toString();
    nameController.text =
    ...
    return BlocListener<CreateRentPropertyCubit, CreateRentPropertyState>(
      listener: (context, state) async {
        if (state is CreateRentPropertyLoading) {
          ...
          snackBar(context, 'Rent property created successfully', Icons.done,
              AppTheme.guestColor);
      ...
      child: Scaffold(
        appBar: appbarWidget(title: 'Rent My Property'),
                    ...
                    onTap: () {
                      if (formkey.currentState!.validate()) {
                        if (amenitiesList.isEmpty) {
                          snackBar(context, 'Please select amenities type',
                              Icons.cancel, AppTheme.redColor);
                        } else {
                          documentFiles.clear();
                          ...
                          context
                              ...
                              .createRentProperty(
                                  ...
                                  monthlyRent: rentController.text.toString(),
                                  securityDeposit:
                                      securityDepositController.text.toString(),
