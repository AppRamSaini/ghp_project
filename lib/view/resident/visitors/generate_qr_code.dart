...
class VisitorGatePass extends StatefulWidget {
  ...
  @override
  State<VisitorGatePass> createState() => _VisitorGatePassState();
}

class _VisitorGatePassState extends State<VisitorGatePass> {
  ...
  Widget build(BuildContext context) {
    final Map<String, dynamic> visitorDetails = {
      'visitor_id': widget.visitors.id.toString()
    };
    String jsonDetails = jsonEncode(visitorDetails);
