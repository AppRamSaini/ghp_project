...
class _EmergencyContactScreenState extends State<EmergencyContactScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appbarWidget(title: 'Emergency Contacts'),
      body: RefreshIndicator(
        onRefresh: onRefresh,
        child: BlocBuilder<SocietyContactsCubit, SocietyContactsState>(
          builder: (context, state) {
            if (state is SocietyContactsLoading) {
              ...
              return ListView.builder(
                  ...
                  itemCount: state.societyContacts.first.data.contacts.length,
                  shrinkWrap: true,
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                            state.societyContacts.first.data
                                                .contacts[index].name,
